...
const partnersImagesArray = [
  [
    "./images/PartnerLogos/cascaisShopping.png",
    "https://www.cascaishopping.pt/en/home/",
  ],
  [
    "./images/PartnerLogos/ADEGAfundobranco.jpg",
    "https://www.adegaviuvagomes.com",
  ],
  [
    "./images/PartnerLogos/Logo_Freeport.jpg",
    "https://freeportfashionoutlet.pt",
  ],
  [
    "./images/PartnerLogos/logotipo_penaaventura.png",
  ...
  [
    "./images/PartnerLogos/centrohipico_logo.jpg",
    "https://www.centrohipicocostaestoril.com",
  ],
  ...
  [
    "./images/PartnerLogos/bouldersintra.jpg",
    "https:/www.instagram.com/bouldersintra/",
  ],
  [
    "./images/PartnerLogos/LogoSapa.jpg",
    "https://www.facebook.com/queijadasdasapa/",
  ],
  ["./images/PartnerLogos/LogoBiester-01.png", "https://www.biester.pt"],
  ["./images/PartnerLogos/PenhaLonga.png", "https://www.penhalonga.com/"],
  [
    "./images/PartnerLogos/casa_do_prego.png",
    "https://www.tripadvisor.com/Restaurant_Review-g189164-d23959309-Reviews-Casa_Do_Prego_Vila_De_Sintra-Sintra_Sintra_Municipality_Lisbon_District_Central_.html",
  ],
];
...
const renderImages = () => {
  return Object.entries(galleryImages).map((entry) => {
    return (
      <GalleryImage key={entry[1]} imageSrc={entry[1]} imageTitle={entry[0]} />
    );
  });
};
...
const Gallery = (props: GalleryProps) => {
  ...
  const partnerImages = partnersImagesArray.map((image) => {
    return (
      <PartnerShipLink key={image[1]} href={image[1]}>
        <PartnerShipImage imageSrc={image[0]} />
      </PartnerShipLink>
    );
  });
      ...
      <GallerySection id="places">
        ...
        {isMobileDevice ? (
          ...
          <GalleryWrapper id="wrapper">
            <GalleryImageWrapper>{renderImages()}</GalleryImageWrapper>
          </GalleryWrapper>
        )}
        <PartnerShipContainer>
          <PartnerShipTitle>{partnerTitle}</PartnerShipTitle>
          <PartnerShipWrapper>{partnerImages}</PartnerShipWrapper>
        </PartnerShipContainer>
      </GallerySection>
    </Element>
  );
