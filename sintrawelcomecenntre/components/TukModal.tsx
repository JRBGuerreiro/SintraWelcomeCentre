...
const Animation = styled.div<{ divOpacity: boolean; animate: boolean }>`
  ...
  transform: ${({ animate }) =>
    animate ? "translateY(0vh)" : "translateY(-100vh)"};
  transition: all 0.5s;
  display: flex;
  height: 100%;
  width: 100vw;
        ...
        <Animation animate={props.showModal} divOpacity={props.showModal}>
          <Modal>
            ...
            <ModalIconsWrapper>
              <IconsContainer>
                <FiThumbsUp
                  style={{ color: "#333", width: "22px", height: "22px" }}
                />
                <IconsText>{modaltext.general[props.language].free}</IconsText>
              </IconsContainer>
              <IconsContainer>
                <BsPerson
                  style={{ color: "#333", width: "22px", height: "22px" }}
                />
                <IconsText>{modaltext.general[props.language].live}</IconsText>
              </IconsContainer>
              <IconsContainer>
                <RiMentalHealthLine
                  style={{ color: "#333", width: "22px", height: "22px" }}
                />
                <IconsText>{modaltext.general[props.language].covid}</IconsText>
              </IconsContainer>
              <IconsContainer>
                <GiDuration
                  style={{ color: "#333", width: "22px", height: "22px" }}
                />
                <IconsText>{props.data[1]}</IconsText>
              </IconsContainer>
            </ModalIconsWrapper>
          </Modal>
        </Animation>
