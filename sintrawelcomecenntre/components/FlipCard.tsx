    ...
    <FlipCardWrapper>
      <FlipCardInner>
        <FlipCardFront>
          ...
          <CardWrapperContent>
            <CardDescription>
              {titles[props.language].cardTitle}
            </CardDescription>
          ...
          {props.disclaimer ? (
            <>
              <FlipCardBackIconWrapper>
                <GrSchedule />
                <p style={{ fontSize: "11pt", margin: "2px 0 5px 5px" }}>
                  12:00/15:00/17:00
                </p>
              </FlipCardBackIconWrapper>
              <FlipCardBackIconWrapper>
                <GiSandsOfTime />
                <p style={{ fontSize: "11pt", margin: "5px 0 2px 5px" }}>
                  1h/1h30m
                </p>
              </FlipCardBackIconWrapper>
              <FlipCardBackText>{props.disclaimer}</FlipCardBackText>
              <FlipCardBackTextCentered>Contact us:</FlipCardBackTextCentered>
              <FlipCardBackIconWrapper>
                <IconWrapper
